class PriceSelectionTabV1 extends React.Component {
	constructor(props) {
        super(props);
        this.state = {
        ...
        if(this.props.receiveType=="memory-plus"){
	        ...
	        return(
	            <div id="packages" style={{margin: "5% 0 0 0"}}>
	                ...
	                <h3 style={{marginBottom: "20px"}}>{(headerNumber)+'انتخاب قیمت'}
                  </h3>
	                <ServicePackagesTab
                        ...
                        shootTypeSelectedExtendedHourCost={this.props.shootTypeSelectedExtendedHourCost}
                    />
