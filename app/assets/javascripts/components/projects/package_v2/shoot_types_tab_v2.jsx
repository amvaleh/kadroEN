class ShootTypesTabV2 extends React.Component{
    constructor(props) {
        super(props);
        this.state = {
    ...
    submitShootCallApi(id){
        ...
        let url=this.props.link+'/api/v3/accept_shoot_type';
        return fetch(url, {method:'post',
            ...
            .then((r)=>r.json().then((r2) =>{
                ...
                this.setState({recommendationGalleryIndex: recommendationHour});
                this.setState({recommendationMemoryIndex: recommendationHour});
        ...
        return (
            <React.Fragment>
                ...
                <div className="wrapper" id="detail" >
                    ...
                    {(this.state.locationWasSelected==false && this.state.shoot_type_selected_id!='')?
                        <WhereV2
