class Api::V2::PhotographersController < ApiController
  ...
  def switched_direct_photographer
    if @project.direct_book
      if params[:direct_photographer_missed]
        Photographers::DirectPhotographerMissed.call(direct_photographer_missed: params[:direct_photographer_missed])
      end
      @project.direct_book = false
      @project.save
      message = "تعویض فرآیند صورت گرفت."
