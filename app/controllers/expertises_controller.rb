class ExpertisesController < ApplicationController
  ...
  def new
    ...
    @expertise = Expertise.create!(photographer_id: @photographer.id,shoot_type_id: @shoot_type.id)
    redirect_to edit_expertise_photographer_url(@photographer, expertise_id: @expertise.id ,shoot_type_id: @shoot_type.id)
  end
  ...
  def receive_photo
    ...
    respond_to do |format|
      if @photo.save
        redirect_to edit_expertise_photographer_url(@photographer, expertise_id: @expertise.id ,shoot_type_id: @shoot_type.id), notice:"sucessfully updated!"
      end
