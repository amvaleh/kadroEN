module GoogleApis
  class GetAreaAndCityName
    ...
    def call
      results = Net::HTTP.get(URI.parse(URI.encode("https://maps.googleapis.com/maps/api/geocode/json?latlng=#{context.lat},#{context.long}&result_type=neighborhood&key=AIzaSyBqAlo6eTQeSbkOn3xYIjJ4e1zr4ewrSxU&language=fa&region=IR")))
