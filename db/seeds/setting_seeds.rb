...
Setting.find_or_create_by(:var=>"reminder_completing_sms_url",:value=>"https://www.kadro.me/", :description=>"صفحه فرود برای یادآوری کننده های اس ام اس")
...
Setting.find_or_create_by(var: 'book_link',value: 'https://app.kadro.me/book', description: "لینک دعوت به تکمیل سفارش که در پیامک زمانیکه مشتری تلفن را پاسخ نداده و سفارش را ناقص رها کرده است ارسال می شود.")
